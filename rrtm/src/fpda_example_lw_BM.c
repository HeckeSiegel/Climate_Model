...
int main() {
      ...
      double **dtau_mol_lw;   // [nbands][nlay]       
      double **wgt_lw;        // [nbands][nlay]       
      ...
      cfpda_rrtm_lw (nlay,plev,tlay, h2ovmr, o3vmr, co2vmr, ch4vmr, n2ovmr, o2vmr,
		     cfc11vmr,cfc12vmr,cfc22vmr,ccl4vmr,
		     &nbands, &band_lbound,&band_ubound, &wgt_lw, &dtau_mol_lw);
